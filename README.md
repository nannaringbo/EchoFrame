...
(1) Website:
EchoFrame can be accessed from the Chrome browser on an Android phone (NOTE: WebXR is not compatible with iOS) by following this link: https://nannaringbo.github.io/EchoFrame/.
...
Run "npm install" in the terminal, to install all dependencies and dev dependencies.
